...
class _SignInPageState extends State<SignInPage> {
  ...
  @override
  void initState() {
    emailController.text = 'quockhanh02@gmail.com';
      ...
      child: Scaffold(
        ...
        body: BlocListener<SignInBloc, SignInState>(
          listener: (context, state) {
            ...
            } else if (state is SignInUnSuccessState) {
              showDialog(
                context: context,
                builder: (context) =>
                    DialogCustom.emailPasswordIncorrectDialog(context),
              );
            }
          },
          child: SafeArea(
                      ...
                      BlocBuilder<SignInBloc, SignInState>(
                        builder: (context, state) {
                          ...
                          return NormalButtonCustom(
                            ...
                            onPress: () {
                              context.read<SignInBloc>().add(SignInPressEvent(
